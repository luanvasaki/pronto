    ...
    for (const sourceJob of sourceJobs) {
      ...
      const job = await createJob(
        ownerUserId,
        {
          ...
          mealProvision: sourceJob.mealProvision,
          mealAmount: sourceJob.mealAmount ?? undefined,
          transportProvision: sourceJob.transportProvision,
          transportAmount: sourceJob.transportAmount ?? undefined,
          minorsAllowed: sourceJob.minorsAllowed,
