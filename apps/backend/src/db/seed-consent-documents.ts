...
Dados institucionais [A PREENCHER antes da publicação em produção]: razão social, nome empresarial e CNPJ da entidade responsável pela operação — [A PREENCHER]. Endereço físico ou eletrônico oficial para notificações — [A PREENCHER]. Canal de suporte ao usuário — [A PREENCHER]. Canal de privacidade e identificação do encarregado — [A PREENCHER]. Canal para denúncias, contestações e comunicações jurídicas — [A PREENCHER].`,
  },
];
