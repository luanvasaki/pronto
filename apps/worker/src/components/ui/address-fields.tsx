...
/**
 * CEP → busca automática de rua/bairro/cidade/UF (ViaCEP) — mesmo padrão
 * já usado no endereço de vaga da empresa (ver apps/business/.../address-fields.tsx).
 * Bairro/cidade/UF não têm input próprio: só aparecem como confirmação
 * depois que o CEP resolve, e entram junto na hora de montar o endereço
 * final (ver buildAddressLabel).
 */
...
/** Monta o endereço final (o que o backend guarda em homeAddressFull) a partir dos campos estruturados. */
